...
export default function SocialSideBar() {
    ...
    return (
        <SideBar>
            <SocialLink href="https://github.com/TibereDbzt/" target="_blanck">
            ...
            <SocialLink href="https://www.linkedin.com/in/tibere-debizet/" target="_blanck">
            ...
            <SocialLink href="https://twitter.com/TibereDebizet" target="_blanck">
                <svg width="17" height="14" viewBox="0 0 27 22" fill="none" xmlns="http://www.w3.org/2000/svg">
